...
import { View, ScrollView, Animated, Image, Platform } from 'react-native';
...
export default class ScrollHeader extends React.Component {
  ...
  componentWillMount() {
    ...
    let finalHeaderBackgroundColor = this.convertHexToRGB(this.props.finalHeaderBackgroundColor);
  ...
  handleTabPress(tab) {
    const scrollPosition =
      this.props.maxHeaderHeight - this.state.minHeaderHeight + this.state.tabBarY;
  ...
  render() {
    const headerScrollDistance = this.props.maxHeaderHeight - this.state.minHeaderHeight;

    const headerHeight = this.state.scrollY.interpolate({
      inputRange: [0, headerScrollDistance],
      outputRange: [this.props.maxHeaderHeight, this.state.minHeaderHeight],
      extrapolate: 'clamp',
    });
    ...
    const backgroundColor = this.state.scrollY.interpolate({
      ...
      outputRange: [
        ...
        `rgba(${this.state.finalHeaderBackgroundColor.r}, ${
          this.state.finalHeaderBackgroundColor.g
        }, ${this.state.finalHeaderBackgroundColor.b}, ${(headerScrollDistance / 2,
    ...
    const headerTextComponent = (
      <View style={[styles.headerTextContainer, this.props.headerTextContainerStyle]}>
        <Animated.Text
          style={[styles.headerText, this.props.headerTextStyle, { opacity: textOpacity }]}
          numberOfLines={1}
        >
    ...
    return (
      <View style={styles.container}>
        <Animated.View style={[styles.headerContainer, { height: headerHeight, backgroundColor }]}>
          <Animated.Image
          ...
          <HeaderBar
            ...
            handleLeftIconPress={this.props.handleHeaderLeftIconPress}
            leftIconStyle={this.props.headerLeftIconStyle}
            rightIconName={this.props.headerRightIconName}
            handleRightIconPress={this.props.handleHeaderRightIconPress}
